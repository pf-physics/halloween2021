...
const Rules1 = (phase) => () => <>
	...
	<p>You have a minute and a half to draw (up to 2 drawings)</p>
...
const dialogue = (code, room) =>
	...
	{text: (room >= 4) ? "I'm feeling a little tired. Why don't we take a rest here?" : "Let us visit the pumpkin patch now! I'll meet you there."}
