...
const Rules1 = () => <>
	...
	Drink twice if you get it in the net.
	</p>
...
const dialogue = (code) => [
	...
	{text: "We feel the moon is weakening. Even spiders need the moon."},
	{text: "Even so, I worked hard on these eggs so I cannot give them for free."},
