...
const Rules4 = () => <>
	...
	<p> Take the charged moon wands and head outside. </p>
...
const dialogue = (code) => [
	...
	{text:"It's time for the last part of the ritual! The zombie now has one more task to complete. He will send the moon energy back into the sky!"},
